...
public final class FragmentInicioBinding implements ViewBinding {
  ...
  private FragmentInicioBinding(@NonNull NestedScrollView rootView,
      @NonNull CardView btnIngresarNotas, @NonNull CardView btnMarcarAsistencia,
      @NonNull CardView btnModificarNotas, @NonNull CardView btnVerNotas,
      @NonNull CardView cardPendientes, @NonNull LinearLayout layoutHeader,
      @NonNull ProgressBar progressHome, @NonNull RecyclerView rvCursos, @NonNull TextView tvAvatar,
  ...
  public static FragmentInicioBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentInicioBinding((NestedScrollView) rootView, btnIngresarNotas,
          btnMarcarAsistencia, btnModificarNotas, btnVerNotas, cardPendientes, layoutHeader,
          progressHome, rvCursos, tvAvatar, tvCantidadPendientes, tvFecha, tvNombreProfesor,
          tvVerCursos);
    }
